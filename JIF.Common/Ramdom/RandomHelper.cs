...
namespace JIF.Common
{
    public static class RandomHelper
    {
        ...
        /// <returns></returns>
        public static string Generate(Format format, int len)
        {
            return string.Empty;
        }
